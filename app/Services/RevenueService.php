...
class RevenueService implements RevenueServiceInterface
{
    ...
    public function allRevenues()
    {
        ...
        $totalRevenuesByMonth = $this->repository->getTotalByMonth();
        ...
        $totalRevenuesByMonth = array_map(function($totalRevenuesByM) {
            $totalRevenuesByM->total_mes = Helpers::formatMoney($totalRevenuesByM->total_mes);
            return $totalRevenuesByM;
        }, $totalRevenuesByMonth);

        $revenuesByMounth = Helpers::groupByMonth($revenues);
        $totalRevenuesByMonth = Helpers::groupByMonth($totalRevenuesByMonth);

        return ['revenues' => $revenuesByMounth, 'totais' => $totalRevenuesByMonth];
    }

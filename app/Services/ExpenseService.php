...
class ExpenseService implements ExpenseServiceInterface
{
    ...
    public function allExpenses()
    {
        ...
        $totalExpensesByMonth = $this->repository->getTotalByMonth();
        ...
        $totalExpensesByMonth = array_map(function($totalExpensesByM) {
            $totalExpensesByM->total_mes = Helpers::formatMoney($totalExpensesByM->total_mes);
            return $totalExpensesByM;
        }, $totalExpensesByMonth);

        $expensesByMounth = Helpers::groupByMonth($expenses);
        $totalExpensesByMonth = Helpers::groupByMonth($totalExpensesByMonth);

        return ['expenses' => $expensesByMounth, 'totais' => $totalExpensesByMonth];
    }

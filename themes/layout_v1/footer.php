...
<footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">&copy; <?=date('Y');?><a class="ml-25" href="javascript:void(0)" target="_blank">MLV Tecnologia</a><span class="d-none d-sm-inline-block"></span></span><span class="float-md-right d-none d-md-block">Versão 1.0.0</span></p>
    </footer>
